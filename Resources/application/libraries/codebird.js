...
var Codebird = function() {
	...
	var http_build_query = function(formdata, numeric_prefix, arg_separator) {
		...
		var value, key, tmp = [], that = http_build_query;
	...
	var _detectMethod = function(method, params) {
		...
		// Trends
		'trends/place', 'trends/available', 'trends/closest',
		...
		// Lists
		'lists/members/destroy', 'lists/subscribers/create', 'lists/subscribers/destroy', 'lists/members/create_all', 'lists/members/create', 'lists/destroy', 'lists/update', 'lists/create', 'lists/members/destroy_all',

		// Saved Searches
		'saved_searches/create', 'saved_searches/destroy/:id',
		...
		// OAuth
		'oauth/access_token', 'oauth/request_token', 'oauth2/token', 'oauth2/invalidate_token'];
